...
class CommentsTest extends Tests\TestCase
{
    public function testGetAllComments()
    {
        ...
        $comments = $this->getApiMock('Gentle\Bitbucket\API\Repositories\PullRequest\Comments');
        $comments->expects($this->once())
            ->method('requestGet')
            ->with($endpoint)
            ->will( $this->returnValue($expectedResult) );

        /** @var $comments \Gentle\Bitbucket\API\Repositories\PullRequest\Comments */
    ...
    public function testGetSingleComment()
    {
        ...
        $comment = $this->getApiMock('Gentle\Bitbucket\API\Repositories\PullRequest\Comments');
        $comment->expects($this->once())
            ->method('requestGet')
            ->with($endpoint)
            ->will( $this->returnValue($expectedResult) );

        /** @var $comment \Gentle\Bitbucket\API\Repositories\PullRequest\Comments */
